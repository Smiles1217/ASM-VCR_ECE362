	XDEF Check_Date
	XREF disp, display_string, StoreIND, Keypad, Counter, Enter_Time, Enter_Date, MO, DAY, YEAR
...
Return:		JSR Enter_Date			;Ask the user to enter in a date again




CheckY: 	LDAA disp+23			;Ensures date isn't greater than 2018
			SUBA #$30
			CMPA #0
			BNE Invalid 
			LDAA disp+24
